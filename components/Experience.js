  ...
  return (
    <section className="bg-neutral-100 dark:bg-neutral-800">
      ...
      <div className="-mt-10 bg-neutral-200 dark:bg-neutral-900">
        <div className="max-w-6xl grid grid-cols-1 dark:bg-neutral-900 mx-auto py-[7rem]">
          {/* Experience card */}
...
const ExperienceCard = ({ title, desc, year, company, companyLink }) => {
  return (
    <div className="relative experience-card border p-4 rounded-md shadow-xl bg-neutral-100 z-10 mx-4">
      ...
      <p className="text-neutral-500 dark:text-neutral-300 my-2">{desc}</p>
    </div>
  );
};