    ...
    <div className="bg-[#dadada] -mt-40 dark:bg-meadows-200">
      <div className="max-w-6xl mx-auto">
        <header className="flex flex-col md:flex-row justify-between items-center pt-40 mx-10 md:my-20 lg:my-0">
          ...
          <Link href="/projects">
            <a className="mb-20 md:mb-0 px-8 py-4 rounded-md bg-white md:text-[#919191] shadow-lg text-xl font-semibold flex flex-row space-x-4 items-center dark:text-meadows-700">
              <svg
